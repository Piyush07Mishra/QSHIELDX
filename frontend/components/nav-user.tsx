// OOP: Encapsulation — This component encapsulates user menu actions, profile display, and sign-out behavior.
// OOP: Abstraction — Exposes a simple user menu interface while hiding auth session details.
